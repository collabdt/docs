...
Point cloud renderer for LiDAR scans and photogrammetry datasets, driven as an object inside the BIM viewer's Three.js scene rather than as a viewer of its own.

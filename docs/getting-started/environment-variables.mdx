...
| `NEXT_PUBLIC_POINTCLOUD_API_URL` | Base URL of the point cloud conversion and streaming service. Required to upload or render point clouds in the BIM viewer. | `https://pointcloud.example.com` |
